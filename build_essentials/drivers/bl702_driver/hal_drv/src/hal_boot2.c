...
{
#if defined(bl702_rv)
    GLB_GPIO_Type gpios[] = { GPIO_PIN_26, GPIO_PIN_27 };

    GLB_GPIO_Func_Init(GPIO_FUN_UART, gpios, 2);

    GLB_UART_Fun_Sel((GPIO_PIN_26 % 8), GLB_UART_SIG_FUN_UART0_TXD); //  GPIO_FUN_UART1_TX
    GLB_UART_Fun_Sel((GPIO_PIN_27 % 8), GLB_UART_SIG_FUN_UART0_RXD);
#else
